...
#define MUTEX_REPORTING // comment to exclude runtime reports of mutex problems from release builds
...
static inline int dt_pthread_mutex_lock_with_caller(dt_pthread_mutex_t *mutex,
                                                    const char *file,
                                                    const int line,
                                                    const char *function)
...
static inline int dt_pthread_mutex_trylock_with_caller(dt_pthread_mutex_t *mutex,
                                                       const char *file,
                                                       const int line,
                                                       const char *function)
  TRY_ACQUIRE(0, mutex)
...
static inline int dt_pthread_mutex_unlock_with_caller(dt_pthread_mutex_t *mutex,
                                                      const char *file,
                                                      const int line,
                                                      const char *function)
