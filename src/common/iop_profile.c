                                             ...
                                             const int intent)
{
  ...
  if(filename[0])
  {
    ...
    {
      const dt_colormatrix_t passing = {{1.f,0.f,0.f,0.f},{0.f,1.f,0.f,0.f},{0.f,0.f,1.f,0.f}};
      if(!dt_is_valid_colormatrix(profile_info->matrix_in[0][0]))
      {
        memcpy(profile_info->matrix_in, passing, sizeof(passing));
        transpose_3xSSE(profile_info->matrix_in, profile_info->matrix_in_transposed);
      ...
      {
        memcpy(profile_info->matrix_out, passing, sizeof(passing));
        transpose_3xSSE(profile_info->matrix_out, profile_info->matrix_out_transposed);
